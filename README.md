...
6. In phpmyadmin page, create a new database from the left panel and name it as 'myprodisdb'
7. Import the file 'myprodisdb.sql' inside your newly created database and click ok.
