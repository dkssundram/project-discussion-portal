...
if(isset($_POST['patsub1'])){
  ...
  if($password==$cpassword){
  	$query="insert into stureg(fname,lname,gender,email,contact,password,cpassword) values ('$fname','$lname','$gender','$email','$contact','$password','$cpassword');";
...
{
	$name=$_POST['name'];
	$query="insert into factb(name)values('$name')";
	$result=mysqli_query($con,$query);
	if($result)
 ...
 <div class="jumbotron" id="ab1"></div>
  ...
  <div class="col-md-4">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="studentdetails.php" role="tab" aria-controls="home">Student List</a>
      ...
      <a class="list-group-item list-group-item-action" id="list-messages-list" data-toggle="list" href="#list-messages" role="tab" aria-controls="messages">feedback</a>
      <a class="list-group-item list-group-item-action" id="list-settings-list" data-toggle="list" href="#list-settings" role="tab" aria-controls="settings">facultys Section</a>
  ...
  <div class="col-md-8">
    <div class="tab-content" id="nav-tabContent">
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
        <form class="form-group" method="post" action="func.php">
          <label>facultys name: </label>
          <input type="text" name="name" placeholder="enter facultys name" class="form-control">
          <br>
