...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #4eb8d2, #00c6ff); background-size: cover;">
    <nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav" >
    <div class="container">

      <a class="navbar-brand js-scroll-trigger" href="index.php" style="margin-top: 10px;margin-left:-65px;font-family: 'IBM Plex Sans', sans-serif;"><h4><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp Project Discussion Portal</h4></a>
    ...
    animation: mover 1s infinite alternate;">
      ...
      <div style="color: white;">
         ...
         <div class="col-md-4" style="margin-top: 5%;left: 400px">
